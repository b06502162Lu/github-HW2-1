...
if __name__ == '__main__':
    ...
    parser.add_argument('-config', '-c', help='config file path',default='/work/b07u1234/b06502162/HW2-1/github-HW2-1/adaptive_voice_conversion-master/config.yaml')
    parser.add_argument('-model', '-m', help='model path',default='/work/b07u1234/b06502162/HW2-1/github-HW2-1.ckpt')
    parser.add_argument('-source', '-s', help='source wav path',default='/work/b07u1234/b06502162/HW2-1/github-HW2-1/Corpus/wav48/p1/p1_001.wav')
    parser.add_argument('-target', '-t', help='target wav path',default='/work/b07u1234/b06502162/HW2-1/github-HW2-1/Corpus/wav48/p2/p2_002.wav')
    parser.add_argument('-output', '-o', help='output wav path',default='/work/b07u1234/b06502162/HW2-1/Lu_test001.wav')
