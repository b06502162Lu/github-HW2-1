...
if __name__ == '__main__':
    ...
    parser.add_argument('-target', '-t', help='target wav path',default='/work/b07u1234/b06502162/HW2-1/github-HW2-1/Corpus/wav48/p2/p2_100.wav')
    parser.add_argument('-output', '-o', help='output wav path',default='/work/b07u1234/b06502162/HW2-1/demo/Lu_p1mid_p2mid')
