...
if __name__ == '__main__':
    ...
    parser.add_argument('-attr', '-a', help='attr file path',default='/work/b07u1234/b06502162/HW2-1/github-HW2-1/vctk/trimmed_vctk_spectrograms/sr_24000_mel_norm')
    ...
    parser.add_argument('-target', '-t', help='target wav path',default='/work/b07u1234/b06502162/HW2-1/github-HW2-1/Corpus/wav48/p2/p2_001.wav')
    parser.add_argument('-output', '-o', help='output wav path',default='/work/b07u1234/b06502162/HW2-1')
